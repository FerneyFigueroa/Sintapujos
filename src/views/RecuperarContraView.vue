		...
		<main>
			...
			<div class="divrecuperar">
				<div class="cont1">
					...
					<!--inserto modal-->
					<div class="contenedormodal1">
						<div class="modal fade" tabindex="-1" id="modalcodigo" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="titulomodal1">Ingresa el código de seguridad</h4>
									...
									<div class="modal-body">
										<p class="textcodigo">Comprueba si recibiste un correo electrónico con tu código de
											6 dígitos.</p>
										<input type="text" class="inputcodigo" placeholder="Ingresa el código" v-model="recoveryCode">
										<p class="textcodigo">Escribe tu nueva contraseña.</p>
										<input type="password" class="inputcodigo" v-model="password">
...
const actualizarcontrasena = () => {
	...
	axios.patch(`https://sintapujos2023-rm77.onrender.com/actualizarContrasena/${this.email}`, {
		codigoRecuperar: recoveryCode.value,
